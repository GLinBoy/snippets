// Source: https://github.com/lencx/tauri-tutorial/blob/main/src-tauri/src/omb/tray.rs
...
pub fn handler(app: &AppHandle, event: SystemTrayEvent) {
    match event {
        SystemTrayEvent::LeftClick {
            ...
            let win = app.get_window("snippets").unwrap();
            win.show().unwrap();
        ...
        SystemTrayEvent::MenuItemClick { id, .. } => match id.as_str() {
            ...
            "hide" => {
                let window = app.get_window("snippets").unwrap();
                window.hide().unwrap();
            }
            "show" => {
                let window = app.get_window("snippets").unwrap();
